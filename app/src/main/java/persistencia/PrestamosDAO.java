			...
			if (column.equals("ISBN")){
				...
				query.append("""
                 ...
                 FROM filtro_pattern INNER JOIN ejemplares
                                       ON filtro.pattern.ISBN=ejemplares.ISBN
				...
				query.append("""
                 ...
                 WHERE prestamos.devuelto='NO' OR to>CURRENT_DATE())
				...
				query.append("""
                 ...
                 FROM lib_ej_prestamos INNER JOIN afiliados
                                       ...
                                       INNER JOIN lib_ej_prestamos.id_biblioteca_afiliado=bibliotecas.id;
                 ORDER BY from;                           
                 """);
			}
			else {
				...
				query.append("(devuelto='NO' or to>CURRENT_DATE())), ");
